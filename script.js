function verificarAniversario() {
    ...
    if (hoje.getDate() == diaNascimento && hoje.getMonth() + 1 == 12) {
        // se for o aniversário do usuário, exibe a mensagem de parabéns
        document.getElementById("resultado").innerHTML = "Parabéns pelo seu dia, meu amor! Você é a melhor pessoa do mundo e eu te amo muito!";
    } else {
